...
## Project Structure
    ...
    ├── ideapros_llc_clutch_32418  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_clutch_32418`
...
2. Clone this repo and `cd ideapros_llc_clutch_32418`
